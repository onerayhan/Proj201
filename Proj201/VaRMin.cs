...
namespace Proj201
{
    public class VaRMin : RollEstIndBase
    {
        public VaRMin(MetricWrapper wrapper) : base(wrapper)
        {
        }
        ...
        public override void onBarUpdate()
        {
            ...
            if (getMonthInt(wrapper.getCurrent().date) != currentMonth)
            {
                ...
                double temp = ((ReturnIndicator)wrapper.getObserver("Return")).getValues().Min();
                values.Add(temp);
            }
        }
